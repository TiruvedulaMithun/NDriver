...
/**
 * BTrail6SerialCommConfig Handles the serial communication for the driver.
 *
 * @author TRAIL6 on 07 May 2025
 */
@NiagaraType
public class BTrail6SerialCommConfig
  extends BSerialCommConfig
{
//region /*+ ------------ BEGIN BAJA AUTO GENERATED CODE ------------ +*/
//@formatter:off
/*@ $com.trail6.trail6.comm.BTrail6SerialCommConfig(2979906276)1.0$ @*/
/* Generated Wed May 07 10:17:22 EDT 2025 by Slot-o-Matic (c) Tridium, Inc. 2012-2025 */
  ...
  public static final Type TYPE = Sys.loadType(BTrail6SerialCommConfig.class);
...
//endregion /*+ ------------ END BAJA AUTO GENERATED CODE -------------- +*/
   ...
   * Empty constructor
   */
  public BTrail6SerialCommConfig()
  {
  }
...
//  public int getMaxOutstandingTransactions() { return 1; }
  ...
  protected NLinkMessageFactory makeLinkMessageFactory()
  {
    ...
    return new NLinkMessageFactory(1024)
    {
      ...
      {
        return new Trail6SerialLinkMessage(1024);
      }
    };
  }
