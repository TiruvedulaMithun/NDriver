 ...
 */
@NiagaraType(
  agent = @AgentOn(types = { "trail6:Trail6PointDeviceExt", "trail6:Trail6PointFolder" })
)
public class BTrail6PointManager
...
/* Generated Wed May 07 11:13:26 EDT 2025 by Slot-o-Matic (c) Tridium, Inc. 2012-2025 */
  ...
  public static final Type TYPE = Sys.loadType(BTrail6PointManager.class);
...
////////////////////////////////////////////////////////////////
  ...
  static Lexicon lex = Lexicon.make(BTrail6PointManager.class);
  ...
  // Trail6ProxyExt specific columns
  MgrColumn[] cols =
  {
