...
/**
 * BTrail14PointDiscoveryLeaf is container class for point elements to display in
...
public class BTrail14PointDiscoveryLeaf
  extends BNPointDiscoveryLeaf
{
//region /*+ ------------ BEGIN BAJA AUTO GENERATED CODE ------------ +*/
//@formatter:off
/*@ $com.mithun.trail14.point.BTrail14PointDiscoveryLeaf(1643154273)1.0$ @*/
/* Generated Tue May 13 05:53:17 EDT 2025 by Slot-o-Matic (c) Tridium, Inc. 2012-2025 */
  ...
  public static final Type TYPE = Sys.loadType(BTrail14PointDiscoveryLeaf.class);

  //endregion Type

//@formatter:on
//endregion /*+ ------------ END BAJA AUTO GENERATED CODE -------------- +*/
  public BTrail14PointDiscoveryLeaf()
  {
  }
...
//    }
  ...
  public void updateTarget(BComponent target)
  {
    ...
    BTrail14ProxyExt pext = new BTrail14ProxyExt();
  ...
  public boolean isExisting(BComponent target)
  {
    ...
    BControlPoint cp = (BControlPoint) target;
    BTrail14ProxyExt pext = (BTrail14ProxyExt) cp.getProxyExt();
    //
