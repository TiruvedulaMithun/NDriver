...
/**
 * Trail14SerialLinkMessage streams data to and from a byte array representation.
 *
 * @author mithun on 13 May 2025
 */
public class Trail14SerialLinkMessage
  extends LinkMessage
{
  public Trail14SerialLinkMessage(int maxLen)
  {
    super(maxLen);
  }
