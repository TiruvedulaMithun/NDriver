...
/**
 * BTrail14TcpCommConfig Handles the tcp communication for the driver.
 *
 * @author mithun on 13 May 2025
 */
@NiagaraType
public class BTrail14TcpCommConfig
  extends BTcpCommConfig
{
//region /*+ ------------ BEGIN BAJA AUTO GENERATED CODE ------------ +*/
//@formatter:off
/*@ $com.mithun.trail14.comm.BTrail14TcpCommConfig(2979906276)1.0$ @*/
/* Generated Tue May 13 05:53:17 EDT 2025 by Slot-o-Matic (c) Tridium, Inc. 2012-2025 */
  ...
  public static final Type TYPE = Sys.loadType(BTrail14TcpCommConfig.class);
...
//  public int getMaxOutstandingTransactions() { return 1; }
  ...
  protected NLinkMessageFactory makeLinkMessageFactory()
  {
    ...
    return new NLinkMessageFactory(1024)
    {
      ...
      {
        return new Trail14TcpLinkMessage(1024);
      }
    };
  }
